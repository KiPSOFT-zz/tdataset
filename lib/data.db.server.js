/**
 * @overview TDataset server connection.
...
var TServerConnection = function() {
        ...
        */
        ...
        /**
        * Database server port. Default 3305.
        * @member DBPort
        * @type {number}
        */
        this.DBPort = 3305;
        ...
        *@param {boolean} Result - This param return true connection established.
        *@param {object} dbConnection DB - This param return DB connection object.
        */
        /**
        * Database connection method.
        * @method Connect
        * @param {callback} OnResult connectionCallBack
        */
...
/**
 * This class extend TDataset. This class binding DB. TDataset not binding.
 * @class TServerDataset
 * @author Serkan KOCAMAN
 */
var TServerDataSet = function() {		    
		...
		this.GeneratorName = "";
		this.Session = null;
		this.Params = new Array();//!< Params property. This property include SQL params. SQL params character "?"
        /**
        * This method add a new record in dataset.
        * @method Append
        * @param {callBack} OnResult - nothing return any param.
        */
        ...
        * @method Delete
        * @param {callback} OnSuccess - this callback return Result and Err params. Result params boolean, Err params string return value.
        */
        ...
        * @method Post
        * @param {callback} OnSuccess - return Result boolean param and Err string param.
        */
        ...
        * @method Open
        * @param {boolean} Fetch - this param using fetching limit (limit sql command) setting the true.
        * @param {integer} Skip - skip record size.
        * @param {integer} First - first record size.
        * @param {callback} OnConnect global return callback.
        */
